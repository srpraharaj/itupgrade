...
public class TeamsController {
	...
	public Response getAllTeams(){
		...
		Iterable<Teams> teams = teamService.getAllTeams();
	...
	@GetMapping("/byId/{id}")
	public Teams getTeamById(@PathVariable("id") int id){
	...
	public void addTopic(@RequestBody Teams team){
		teamService.addTeam(team);
	}
	
	//@RequestMapping(method=RequestMethod.PUT,value="/teams/{id}")
	@PutMapping(value="/{id}")
	public void updateTopic(@RequestBody Teams team,@PathVariable int id){
